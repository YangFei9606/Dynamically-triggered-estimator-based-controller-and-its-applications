...
length=0.1;             % length of the wheel    
width=0.03;              % width of the wheel

% Radius=[0.24;0.23;0.30;0.28;0.25;0.32] - width;

radius=0.14 - width;               % radius of the robot   
...
text(xpos,ypos,int2str(serial_num),'FontSize',13);
hold off